...
document.addEventListener(
    ...
    function () {
      ...
      function onClick() {
        ...
        var el1 = document.getElementById('inspectProj');
        var el2 = document.getElementById('projDetails');
        var el3 = document.getElementById('inspectStories');
        var el4 = document.getElementById('storyDetails');
        if (el1) {
            el1.remove();
        }
        if (el2) {
